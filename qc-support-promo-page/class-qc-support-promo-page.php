...
if ( ! defined( 'qcld_highlight_support_url' ) )
    define('qcld_highlight_support_url', plugin_dir_url( __FILE__ ) );

if ( ! defined( 'qcld_support_img_url' ) )
    define('qcld_support_img_url', qcld_highlight_support_url . "/images" );


/*Callback function to add the menu */
function qcld_highlight_show_promo_page_callback_func()
{
    add_submenu_page(
        "qcld-highlight",
        ...
        esc_html__('Support'),
        'manage_options',
        "qcld-highlight-supports",
        'qcld_highlight_promo_support_page_callback_func'
    );
} //show_promo_page_callback_func

add_action( 'admin_menu', 'qcld_highlight_show_promo_page_callback_func', 10 );
...
if ( ! function_exists( 'qcld_highlight_include_promo_page_scripts' ) ) {	
	function qcld_highlight_include_promo_page_scripts( ) {   


        if( isset($_GET["page"]) && !empty($_GET["page"]) && (   $_GET["page"] == "qcld-highlight-supports"  ) ){

            wp_enqueue_style( 'qcld-support-fontawesome-css', qcld_highlight_support_url . "css/font-awesome.min.css");                              
            wp_enqueue_style( 'qcld-support-style-css', qcld_highlight_support_url . "css/style.css");

            wp_enqueue_script( 'jquery' );
            wp_enqueue_script( 'jquery-ui-core');
            wp_enqueue_script( 'jquery-ui-tabs' );
            wp_enqueue_script( 'jquery-custom-form-processor', qcld_highlight_support_url . 'js/support-form-script.js',  array('jquery', 'jquery-ui-core','jquery-ui-tabs') );

            wp_add_inline_script( 'jquery-custom-form-processor', 
                                    'var qcld_highlight_ajaxurl    = "' . admin_url('admin-ajax.php') . '";
                                    var qcld_highlight_ajax_nonce  = "'. wp_create_nonce( 'qc-clr' ).'";   
                                ', 'before');
            
        }
	   
	}
	add_action('admin_enqueue_scripts', 'qcld_highlight_include_promo_page_scripts');
 ...
 *******************************/
if ( ! function_exists( 'qcld_highlight_promo_support_page_callback_func' ) ) {

	function qcld_highlight_promo_support_page_callback_func() {
		
?>
        <div class="qcld-highlight-support">
            <div class="support-btn-main justify-content-center">
                <div class="col text-center">
                    ...
                    <div class="support-btn">
                        ...
                        <a style="width:282px" class="premium-support" href="<?php echo esc_url('https://www.quantumcloud.com/resources/kb-sections/highlight/'); ?>" target="_blank"><?php esc_html_e('Online KnowledgeBase', 'qc-clr'); ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="qcld-highlight-sup_wrap">

                <div class="qcld-highlight-sup_title">
 ...
 *******************************/
add_action( 'wp_ajax_qcld_highlight_process_qc_promo_form', 'qcld_highlight_process_qc_promo_form' );

if( !function_exists('qcld_highlight_process_qc_promo_form') ){

    function qcld_highlight_process_qc_promo_form(){
